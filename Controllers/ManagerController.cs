...
namespace WFManagementSystemClient.Controllers
{
    public class ManagerController : Controller
    {
        // GET: ManagerController
        List<Manager> details = new List<Manager>();
        public static Manager det1 = new Manager();
        public static Manager det2 = new Manager();
        public static Manager det3 = new Manager();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Manager detail)
        {
            try
            {
